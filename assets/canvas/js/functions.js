...
var oCanvas = {
    ...
    init: function(){
        console.log('canvas initialized');
            SEMICOLON.documentOnReady.reinit();
...
(function($){
    ...
    SEMICOLON.header = {
        ...
        reinit: function(){
            SEMICOLON.header.superfishInit();
            SEMICOLON.header.menufunctions();
            SEMICOLON.header.fullWidthMenu();
            SEMICOLON.header.overlayMenu();
            SEMICOLON.header.stickyMenu();
        ...
        removeStickyness: function(){
            if( $('#header').hasClass('sticky-header') || $('#header').hasClass('sticky-header') ){
    ...
    SEMICOLON.documentOnReady = {
        ...
        reinit: function(){
            SEMICOLON.initialize.reinit();
            SEMICOLON.header.reinit();
            if( $slider.length > 0 ) { SEMICOLON.slider.init(); }
            if( $portfolio.length > 0 ) { SEMICOLON.portfolio.init(); }
            SEMICOLON.widget.reinit();
            SEMICOLON.documentOnReady.windowscroll();
        },
    ...
    $('#primary-menu-trigger').click(
        function(){
            if($('#primary-menu').is(':visible')){
                ...
                $('#primary-menu').attr('style','display:block');
            }
        }
    );
