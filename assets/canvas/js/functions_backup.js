            ...
            if( $('.one-page-menu').length > 0 ){
                ...
                $('.one-page-menu').find('a[data-href]').click(function(){
                    ...
                    if( $( divScrollToAnchor ).length > 0 ) {
                        ...
                        $('.one-page-menu').find('a[data-href="' + divScrollToAnchor + '"]').parent('li').addClass('current');
    ...
    SEMICOLON.slider = {
        ...
        swiperSliderMenu: function(){
            if( $('body').hasClass('device-lg') || $('body').hasClass('device-md') ) {
                ...
                // SEMICOLON.slider.headerSchemeChanger($('#slider').find('.current-sr-slide-visible'));

                if(SEMICOLON.slider.headerSchemeChanger($('#slider').find('.swiper-slide.swiper-slide-visible')).length > 0 ) {
                    if( $('#slider').find('.swiper-slide.swiper-slide-visible').hasClass('dark') ){
                        $('#header.transparent-header:not(.sticky-header,.semi-transparent,.floating-header)').addClass('dark');
                        $('#header.transparent-header.sticky-header,#header.transparent-header.semi-transparent.sticky-header,#header.transparent-header.floating-header.sticky-header').removeClass('dark');
                        $('#header-wrap').removeClass('not-dark');
                    } else {
                        if( $('body').hasClass('dark') ) {
                            $('#slider').find('.swiper-slide.swiper-slide-visible').addClass('not-dark');
        ...
        revolutionSliderMenu: function(){
            if( $('body').hasClass('device-lg') || $('body').hasClass('device-md') ) {
                ...
                // SEMICOLON.slider.headerSchemeChanger(activeSlide);
                // SEMICOLON.slider.headerSchemeChanger($('#slider').find('.current-sr-slide-visible'));
                if( $('#slider').find('.current-sr-slide-visible').length > 0 ) {
                    if( $('#slider').find('.current-sr-slide-visible').hasClass('dark') ){
                        $('#header.transparent-header:not(.sticky-header,.semi-transparent,.floating-header)').addClass('dark');
                        $('#header.transparent-header.sticky-header,#header.transparent-header.semi-transparent.sticky-header,#header.transparent-header.floating-header.sticky-header').removeClass('dark');
                        $('#header-wrap').removeClass('not-dark');
                    } else {
                        if( $('body').hasClass('dark') ) {
                            $('#slider').find('.current-sr-slide-visible').addClass('not-dark');
                            $('#header.transparent-header:not(.semi-transparent,.floating-header)').removeClass('dark');
                            $('#header.transparent-header:not(.sticky-header,.semi-transparent,.floating-header)').find('#header-wrap').addClass('not-dark');
                        } else {
                            $('#header.transparent-header:not(.semi-transparent,.floating-header)').removeClass('dark');
